...
filter Llama a una función sobre cada elemento del arreglo y devuelve un nuevo arreglo, conteniendo solo los elementos para los cuales la función devolvió un valor de verdadero - Es decir, un valor que devuelve true si paso al constructor Boolean(). 
...
const filteredListV2 = watchList
    .filter(movie => movie.imdbRating > 8.0) //Primero aplicamos el filter para asegurarnos que tenemos todos los datos.
    .map(movie => ({                        //con el filtro aplicado ahora ya podemos sacar la información que nos interesa.
        title: movie.Title,
        rating: movie.imdbRating
    }));
