...
"""Array.prototype.map() o más específicamente map"""
...
/*Explicación:
--------------
map(): Utilizamos el método map() para recorrer el arreglo watchList y para cada objeto de película, creamos y devolvemos un nuevo objeto que contiene solo las propiedades title (correspondiente a Title en el objeto original) y rating (correspondiente a imdbRating).

map() devuelve un nuevo arreglo: El método map() crea un nuevo arreglo sin modificar el arreglo original.*/
